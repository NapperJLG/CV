...
### Gemstone IT (June 2024 - Present) — *Lead Developer*
...
### Celer Technologies (October 2022 - June 2024) — *React Developer*
...
### Dacast (August 2019 - April 2021) — *Frontend Engineer*
- One of two early frontend engineers building the company’s new VOD & live streaming platform with React/TypeScript.
...
### AusDiagnostics (August 2016 - March 2019) — *Engineer / Production Assistant / Customer Support*
- Started as a production assistant but was quickly moved into an engineering role.
- Taught myself how to service and repair the in-house liquid handling robots.
- Wrote scripts for the robots so that each product could be manufactured with different configurations.

### Histology Department @ Wycombe General Hospital (January 2013 – August 2016) — *Biomedical Scientist (Band 5)*
- Progressed from Medical Lab Assistant (Band 3) after completing a registration portfolio.
- Responsibilities included cutting 3µl tissue sections using a microtome, staining tissue to aid diagnosis, and assisting junior doctors with tissue sampling.

### ArmChair Partners Ltd. (August 2012 - October 2012) — *Online Poker Marketing Intern*
- Researched and wrote poker and sports articles across various WordPress websites under the ArmChair brand.
- Attended poker tournaments and interviewed professional players for publication.

## Project Showcase

| Project | Description | Tech Used | GitHub |
|--------|-------------|-----------|--------|
| [xLivelyFPL](https://xlivelyfpl.web.app) | Fantasy football blog | Astro, SCSS, Firebase | https://github.com/NapperJLG/xLively-FPL-Astro |
| [What's On?](https://whats-on-5c86e.web.app/) | Browse currently showing films from The Movie Database API | TypeScript, React, Styled Components | https://github.com/NapperJLG/whats-on |
| [Rhythm Is A Maker](https://rhythm-is-a-maker.herokuapp.com/) | Drum sequencer, synth, chat program | JavaScript (Tone.js), Express, Jasmine, Karma, Cypress | https://github.com/NapperJLG/rhythm-is-a-maker |
...
| [MTG Life Counter](https://mtg-life-counter-react.herokuapp.com/) | Track life totals for Magic: The Gathering | React, Bootstrap | https://github.com/NapperJLG/mtg-life-counter-react |

## Education

### Makers Academy (March 2019 - June 2019)
- Web development bootcamp focused on self-directed learning.
- Strong emphasis on TDD and code quality.
- Extensive pair programming and team-based agile workflows.

### University of Kent (September 2010 - June 2012)
- BSc Biomedical Science

## Interests
- Keen musician — play guitar, bass and drums in several bands and perform regularly at Hip Hop Karaoke.
